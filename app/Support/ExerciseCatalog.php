    ...
    private static function build(): array
    {
        ...
        $definitions = [
            ...
            [
                ...
                'summary' => 'Rise and fall like a wave',
                'description' => 'Wave-like squeezes that build and release tension continuously.',
                'how_to' => 'Tighten slowly all the way up, then release a little faster, like a wave rising and falling. Keep it smooth and continuous.',
                'pattern' => [$s(3, 0, 1, 'Contract & hold'), $s(2, 1, 0, 'Relax')],
            ],
            [
                'name' => 'Pulsation',
                'slug' => 'pulsation',
                'unlock_after_days' => 50,
                'summary' => 'Steady one second pulses',
                'description' => 'Rhythmic pulses that build stamina and timing.',
                'how_to' => 'Squeeze for one second, release for one second. Keep every pulse the same strength and stay with the rhythm.',
                'pattern' => [$s(1, 0, 1, 'Contract & hold'), $s(1, 1, 0, 'Relax')],
            ],
            [
                'name' => 'Push',
                'slug' => 'push',
                'unlock_after_days' => 57,
                'summary' => 'Long 5 second build to a peak',
                'description' => 'Build the squeeze gradually to a strong peak, then let go.',
                'how_to' => 'Tighten gradually over 5 seconds, getting stronger as the circle fills, then release. Squeeze harder, never push down or strain.',
                'pattern' => [$s(5, 0, 1, 'Contract & hold'), $s(1, 1, 0, 'Relax')],
            ],
            [
                'name' => 'Upstairs',
                'slug' => 'upstairs',
