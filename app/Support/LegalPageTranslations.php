    ...
    public const SOURCE = [
        'privacy-policy' => [
            ...
            'blocks' => [
                ...
                ['h2', 'What we collect'],
                ['p', 'When you create an account we store your name, email address, and a securely hashed password. If you sign in with Google or Apple, we receive the account details that provider shares with us, such as your name and email address.'],
                ...
                ['h2', 'Payments'],
                ['p', 'Subscriptions are billed by Google Play or the Apple App Store, depending on your device. We never see or store your card details. We receive purchase and subscription status from the store and our billing provider so we can unlock Premium and keep it active across your devices.'],
        ...
        'refund-policy' => [
            'title' => 'Refund Policy',
            'blocks' => [
                ['p', 'Kegelee subscriptions are purchased and billed through Google Play or the Apple App Store. Refunds are handled by the store where you purchased the subscription, under that store\'s refund policy.'],
                ['h2', 'How to request a refund'],
                ['p', 'For a Google Play purchase, open Google Play and use Payments and subscriptions. For an Apple purchase, use Apple\'s Report a Problem service or contact Apple Support. Select the Kegelee purchase and follow the store\'s refund steps.'],
                ['h2', 'Cancelling'],
                ['p', 'You can cancel your subscription at any time in Google Play or your Apple Account subscription settings. You keep full access until the end of the period you paid for, and you will not be charged again after that.'],
                ['h2', 'Need help?'],
