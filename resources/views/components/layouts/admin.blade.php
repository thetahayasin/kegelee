...
<body class="min-h-screen bg-bg text-content antialiased">
    @auth
        ...
        $nav = [
            'content' => [
                ['admin.exercises', 'Exercises', '<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>'],
                ['admin.levels', 'Levels', '<path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/>'],
                ['admin.onboarding', 'Onboarding', '<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>'],
            ...
            'billing' => [
                ['admin.plans', 'Plans', '<rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/>'],
                ['admin.discounts', 'Discounts', '<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>'],
